...
export const ROOT_PATH_IMAGE_REWARDS = "./assets/images/rewards";
export const WIDTH_OF_REWARDS_IN_CANVAS = 0.04;
export const HEIGHT_OF_REWARDS_IN_CANVAS = 0.04;
...
export const NUMBER_OF_SKILLS = 14;
export const FONT_MESSAGE = "48px sans-serif";
export const PAUSE_MESSAGE = "JEU EN PAUSE";
export const PAUSE_MESSAGE_POSX = 0.4;
export const PAUSE_MESSAGE_POSY = 0.5;
export const END_OF_GAME_MESSAGE = ["Félicitations !","Vous avez débloqué","toutes les compétences !"];
export const END_OF_GAME_MESSAGE_POSX = 0.4;
export const END_OF_GAME_MESSAGE_POSY = 0.3;
export const END_OF_GAME_MESSAGE_GAP = 0.2;
export const DELAY_BEFORE_END_OF_GAME_MESSAGE_DISAPPEARANCE = 3000;
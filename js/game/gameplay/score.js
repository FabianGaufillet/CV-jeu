...
export class Score {
     ...
     */
    updateScore(points) {
        const previousScore = this.#formatScore(this.#currentScore);
    ...
    #showScore(previousScore) {
        const scoreToString = this.#formatScore(this.#currentScore);
    ...
    /**
     * Formate le score sur 3 digits
     * @param {number} score Le score à formater
     * @returns {string} Le score formaté sur 3 digits
     */
    #formatScore(score) {

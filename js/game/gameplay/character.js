...
export class Character {
    ...
    /**
     * @property {number} fallingTime Timestamp depuis le début de la chute libre du personnage
     */
    fallingTime;

    /**
     * @property {number} lastStatusChangeTime Timestamp depuis le dernier changement d'état du personnage
     */
    ...
    constructor(type,state) {
        this.#type = type;
        this.#state = state;
        this.#sprite = new Sprite(state,0);
